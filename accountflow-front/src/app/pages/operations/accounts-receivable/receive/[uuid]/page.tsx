...
export default function ReceivableEntryPage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      setToast({ message: 'Erro ao registrar recebimento.', type: 'error' });
    } finally {
      setSaving(false);
    }
  };
      ...
      <div className="card-enhanced animate-[fade-in_0.5s_ease-in-out] space-y-6 rounded-xl p-6">
        ...
        <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-gradient mb-2 text-3xl font-bold">Baixar Título - Contas a Receber</h1>
              <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
                Registre o recebimento para este título.
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="card-enhanced space-y-4 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <TextInput value="Receita" disabled className="bg-muted text-text-muted rounded-lg" />
              </div>
          ...
          {/* Dados do Recebimento (Editáveis) */}
          <div className="card-enhanced space-y-4 rounded-lg p-6">
            <h2 className="text-xl font-semibold">Dados do Recebimento</h2>
