  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="mb-1 text-2xl font-bold text-gray-900">Planos de Contas</h1>
          <p className="text-gray-500">Selecione um plano para gerenciar suas contas.</p>
        </div>
        <Button
          className="cursor-pointer bg-[#0b2034] hover:bg-[#12314d] dark:bg-[#0b2034] dark:hover:bg-[#12314d]"
          onClick={handleNew}
        >
          Novo Plano
        </Button>
      ...
      <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3">
        {billingPlans.map((plan) => (
          <div key={plan.uuid} className="relative rounded-lg border bg-white p-4 shadow transition hover:shadow-md">
        ...
        {billingPlans.length === 0 && (
          <p className="col-span-full py-6 text-center text-gray-400">Nenhum plano cadastrado ainda.</p>
        )}
      </div>
