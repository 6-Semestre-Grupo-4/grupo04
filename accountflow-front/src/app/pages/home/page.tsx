            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-xl border border-border bg-surface p-5 shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-lg font-semibold text-foreground">Relatório DRE</h2>
                </div>
                <span className="text-xs text-primary transition-colors group-hover:underline">
                  Abrir
                </span>
              </div>
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-xl border border-border bg-surface p-5 shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
              ...
              <div className="mb-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-lg font-semibold text-foreground">Razão Contábil</h2>
                </div>
                <span className="text-xs text-primary transition-colors group-hover:underline">
                  Abrir
                </span>
