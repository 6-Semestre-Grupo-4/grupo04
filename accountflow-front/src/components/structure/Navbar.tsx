...
function UserDropdown() {
  ...
  const buttonClass = 
    'w-full text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 rounded text-sm cursor-pointer';
  ...
  return (
    <nav className='h-16 border-b border-gray-200 bg-primary flex items-center px-4 justify-between'>
      ...
      <div className='ml-auto relative group flex items-center gap-2 cursor-pointer'>
        ...
        <span className='text-gray-800 dark:text-gray-200 font-medium'>Nome do usuário</span>
        <UserDropdown />
      </div>
    </nav>
  );
